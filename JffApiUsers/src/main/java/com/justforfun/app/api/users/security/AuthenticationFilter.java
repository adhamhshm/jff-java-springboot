...
import com.justforfun.app.api.users.ui.model.user.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        // The client application that performed login and HTTP request should get
        // back in response headers these two values.
